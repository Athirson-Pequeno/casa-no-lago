/**
 * Valida os campos obrigatórios da reserva e retorna uma mensagem de erro, ou null se tudo OK.
 */
...
/**
 * Valida se as datas são válidas e fazem sentido (início >= hoje, fim >= início).
 * Retorna { inicio, fim } se OK, ou { erro: string } se inválido.
 */
